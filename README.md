...
This is a [vinext](https://github.com/cloudflare/vinext) starter app that uses [Replicate](https://replicate.com) to generate images with [FLUX.2 [klein]](https://replicate.com/black-forest-labs/flux-2-klein-9b). It deploys to [Cloudflare Workers](https://developers.cloudflare.com/workers/).
